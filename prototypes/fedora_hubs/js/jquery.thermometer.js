...
(function($) {
  $.fn.thermometer = function(options, animationCompleteCallbackFunc) {
    var settings = $.extend({
      percent: 0, 
    ...
    return this.each(function() {
      ...
      if(_animate) {
        ...
        $(this).find('.thermometer-inner').animate(animateProperties, _speed, animationCompleteCallbackFunc);
      }
    });
  };
})(jQuery);
